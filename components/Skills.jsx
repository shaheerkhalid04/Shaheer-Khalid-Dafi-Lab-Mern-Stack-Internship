      ...
      <div className="grid gap-5 md:grid-cols-2">
        {skills.map((s, i) => (
          <Reveal key={s.group} delay={i * 0.08}>
            <div className="h-full rounded-xl border border-line bg-panel p-5 transition-colors duration-200 hover:border-amber/30">
              <p className="font-mono text-[12px] text-amber">{s.group}</p>
